...
public class TMBSample extends Sample{
	...
	public TMBSample(int sampleID, String assay, String instrument, String lastName, String firstName, String orderNumber,
			String pathNumber, String tumorSource, String tumorPercent, String runID, String sampleName,
			String coverageID, String callerID, String runDate, String patientHistory, String bmDiagnosis, String note, String enteredBy, String normalRunID, String normalSampleName) {
		super(sampleID, assay, instrument, lastName, firstName, orderNumber, pathNumber, tumorSource, tumorPercent, runID,
